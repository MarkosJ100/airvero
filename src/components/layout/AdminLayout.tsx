        ...
        <div style={{ display: 'flex', minHeight: '100vh' }}>
            ...
            <aside style={{
                ...
                <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', flex: 1 }}>
                    ...
                    <Link to="/admin/calendar" className="btn btn-ghost" style={{ justifyContent: 'flex-start' }}>Calendario</Link>
                    ...
                    <Link to="/admin/settings" className="btn btn-ghost" style={{ justifyContent: 'flex-start' }}>Ajustes</Link>
                </nav>
